...
<html lang="en-US">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <body>
        <div class="logo">
            <span>PAYMENT OF : <?php echo number_format($_SESSION['finalamount'], 2); ?></span>
        </div>
        <div class="title">
  ...
  <div id="home" class="tab-pane fade in active">
        ...
        <div class="box" style="margin-bottom: 0;">        
            <p>
                ...
                <span class="value"><?php echo $selectupiresult['upi1'] ; ?></span>&emsp;&emsp; &emsp;<button class="btn copyBtn1" onclick="window.location.href='upi://pay?pa=<?php echo $selectupiresult['upi1'] ; ?>&pn=2XClub&cu=INR'"> Pay </button>
                <button class="btn copyBtn" data-clipboard-text="<?php echo $selectupiresult['upi1'] ; ?>">Copy</button>
                ...
                <!--<span class="label">Upi Id.&nbsp;: (upi)</span>-->
                <span class="label">UPI ID</span>
                <span class="value"><?php echo $selectupiresult['upi2'] ; ?></span>&emsp;&emsp;<button class="btn copyBtn1" onclick="window.location.href='upi://pay?pa=<?php echo $selectupiresult['upi2'] ; ?>&pn=2XClub&cu=INR'"> Pay </button>
                <button class="btn copyBtn" data-clipboard-text="<?php echo $selectupiresult['upi2'] ; ?>">Copy</button>
  ...
  <div id="menu1" class="tab-pane fade">    
        ...
        <div class="box" style="margin-bottom: 0;">
            ...
            <p>
                ...
                <button  class="btn copyBtn" data-clipboard-text="000000000000">Copy</button>
            </p>
            <p>
                <span class="label">IFSC Code&nbsp;:</span>
                <span class="value">ABCD123456</span>
                <button class="btn copyBtn" data-clipboard-text="ABCD123456">Copy</button>
            </p>
             <p>
                <span class="label">Bank Name&nbsp;:</span>
                <span class="value">TEST Payment Bank</span>
                <button class="btn copyBtn" data-clipboard-text="TEST Payment Bank">Copy</button>
            </p>
             <p>
                <span class="label">Name&nbsp;:</span>
                <span class="value">TEST PROVIDER</span>
...
<form class="paymentRefForm" action="" method="POST" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <input class="form-control" maxlength="7" type="tel" name="deposit" value="<?php echo number_format($_SESSION['finalamount'], 2); ?>" required>
    </div>
    <div class="form-group">
        <label>Registerd Phone Number</label>
        <input class="form-control" type="tel"  maxlength="10" name="email" value=" <?php echo sprintf("%06d",user($con,'mobile',$userid));?>" required>
    </div>
