...
<div id="overlay"></div>
 ...
 ?>
             ...
             <label>Star <br><input type="radio" class="tabbtn" name="tab" value="parity" <?php if($role['tab']=='parity'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
             <label>Parity <br><input type="radio" class="tabbtn" name="tab" value="sapre" <?php if($role['tab']=='sapre'){echo"checked";} ?>></label>&nbsp;&nbsp;&nbsp;&nbsp;
